...
import { findCommand, ALL_PICKER_ENTRIES } from '../commands/index.js';
        ...
        const renderPicker = () => {
            ...
            if (filtered.length === 0) {
                ...
                filtered.forEach((entry, i) => {
                    ...
                    if (i === pickerCursor) {
                        process.stdout.write(chalk.bold.rgb(232, 98, 42)(`  ❯ ${cmdPad}`) +
                            '  ' + entry.description + '\n');
                    }
                    else {
